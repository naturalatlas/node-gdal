...
gdal.Dataset.prototype.read = (function() {
	var read = gdal.Dataset.prototype.read;
	return function(nXOff,nYOff,nXSize,nYSize,data,nBufXSize,nBufYSize,eBufType,nBandCount,bandMap,nPixelSpace,nLineSpace,nBandSpace,extraArg) {
		if (data) data._gdal_type = getTypedArrayType(data);
		return read.apply(this, [
			nXOff,nYOff,nXSize,nYSize,
			data,nBufXSize,nBufYSize,
			eBufType,nBandCount,bandMap,
			nPixelSpace,nLineSpace,nBandSpace,extraArg
		]);
	};
})();

gdal.Dataset.prototype.write = (function() {
	var write = gdal.Dataset.prototype.write;
	return function(nXOff,nYOff,nXSize,nYSize,data,nBufXSize,nBufYSize,eBufType,nBandCount,bandMap,nPixelSpace,nLineSpace,nBandSpace,extraArg) {
		if (data) data._gdal_type = getTypedArrayType(data);
