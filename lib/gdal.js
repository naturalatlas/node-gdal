...
function defaultConcat(array) {
	var self = this;
	array.forEach(function(geom){
		self.add(geom);
	});
	return this;
}
...
gdal.GeometryCollectionChildren.prototype.concat = defaultConcat;
gdal.LineStringPoints.prototype.concat = defaultConcat;
gdal.PolygonRings.prototype.concat = defaultConcat;
