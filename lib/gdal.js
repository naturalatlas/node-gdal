...
gdal.RasterBandPixels.prototype.write = (function() {
	...
	return function(data, x, y, width, height, options) {
		if (!options) options = {};
		return write.apply(this, [data, x, y, width, height, options.buffer_width, options.buffer_height, options.pixel_space, options.line_space]);
	};
})();