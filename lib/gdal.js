...
gdal.LayerFields.prototype.create = function(field_name, field_type) {
	var def = new gdal.FieldDefn(field_name, field_type);
	this.add(def);
	return def;
};
gdal.FeatureFields.prototype.create = function(field_name, field_type) {
	var def = new gdal.FieldDefn(field_name, field_type);
	this.add(def);
	return def;
};
...
gdal.LayerFields.prototype.fromJSON = function(obj) {
