 ...
 * @param {String} mode The mode to use to open the file: `"r"`, `"r+"`, or `"w"`
 * @param {String|Array} [drivers] Driver name, or list of driver names to attempt to use.
 *
 * @param {Integer} [x_size] Used when creating a dataset with the `"w"` mode.
 * @param {Integer} [y_size] Used when creating a dataset with the `"w"` mode.
 * @param {Integer} [band_count] Used when creating a dataset with the `"w"` mode.
 * @param {Integer} [data_type] Used when creating a dataset with the `"w"` mode.
 * @param {String[]} [control_options] Used when creating a dataset with the `"w"` mode.
 *
 * @return {gdal.Dataset}
 */
gdal.open = (function() {
